...
public class DigitalVideoDisc extends Disc implements Playable {
    ...
    public DigitalVideoDisc(int length, String director, int ID, String title, String category, float cost) throws Exception {
    ...
    public void play() throws PlayerException {
        if (this.getLength() > 0) {
        	...
        	throw new PlayerException("Length is a negative number");
        }
    }
